...
class NativeLibrary {
  ...
  void reset_to_rest_pose(
    ...
    return _reset_to_rest_pose(
      assetManager,
      asset,
    );
  }

  late final _reset_to_rest_posePtr = _lookup<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, EntityId)>>(
      'reset_to_rest_pose');
  late final _reset_to_rest_pose = _reset_to_rest_posePtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>, int)>();
  ...
  late final _get_entity_countPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<ffi.Void>, EntityId, ffi.Bool)>>('get_entity_count');
  late final _get_entity_count = _get_entity_countPtr
      .asFunction<int Function(ffi.Pointer<ffi.Void>, int, bool)>();

  ffi.Pointer<ffi.Char> get_entity_name_at(
    ffi.Pointer<ffi.Void> assetManager,
    int target,
    int index,
    bool renderableOnly,
  ) {
    return _get_entity_name_at(
      assetManager,
      target,
      index,
      renderableOnly,
  ...
  late final _get_entity_name_atPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void>, EntityId,
              ffi.Int, ffi.Bool)>>('get_entity_name_at');
  late final _get_entity_name_at = _get_entity_name_atPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void>, int, int, bool)>();
  ...
  void create_filament_viewer_async_ffi(
    ffi.Pointer<ffi.Void> context,
    ffi.Pointer<ffi.Void> platform,
    ffi.Pointer<ffi.Char> uberArchivePath,
    ffi.Pointer<ffi.Void> loader,
    ...
    return _create_filament_viewer_async_ffi(
      context,
      platform,
      uberArchivePath,
      loader,
  ...
  late final _create_filament_viewer_async_ffiPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Pointer<ffi.Void>,
                  ffi.Pointer<ffi.Void>,
  ...
  late final _create_filament_viewer_async_ffi =
      _create_filament_viewer_async_ffiPtr.asFunction<
          void Function(
              ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Char>,
  ...
  void reset_to_rest_pose_ffi(
    ffi.Pointer<ffi.Void> assetManager,
    int entityId,
  ) {
    return _reset_to_rest_pose_ffi(
      assetManager,
      entityId,
    );
  }

  late final _reset_to_rest_pose_ffiPtr = _lookup<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, EntityId)>>(
      'reset_to_rest_pose_ffi');
  late final _reset_to_rest_pose_ffi = _reset_to_rest_pose_ffiPtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>, int)>();
...
typedef ResourceLoaderWrapper = ffi.Void;
typedef DartResourceLoaderWrapper = ffi.Pointer<ffi.Void>;
