...
void flutter_filament_web_load_resource_callback(Pointer<Void> data, int length, Pointer<Void> context) {
...
Pointer<Void> flutter_filament_web_get_pointer(Pointer<Pointer<Void>> ptr, int offset) {
...
void flutter_filament_web_set_float(Pointer<Float> ptr, int offset, double val) {
   _lib.flutter_filament_web_set_float(ptr, offset, val);
}

void flutter_filament_web_set_double(Pointer<Double> ptr, int offset, double val) {
   _lib.flutter_filament_web_set_double(ptr, offset, val);
}

void flutter_filament_web_set_pointer(Pointer<Pointer<Void>> ptr, int offset, Pointer<Void> val) {
...
Pointer<Void> create_filament_viewer(Pointer<Void> context, Pointer<Void> loader, Pointer<Void> platform, Pointer<Char> uberArchivePath) {
  return _lib.create_filament_viewer(context, loader, platform, uberArchivePath);
}
...
void create_render_target(Pointer<Void> viewer, int texture, int width, int height) {
...
void set_background_image(Pointer<Void> viewer, Pointer<Char> path, bool fillHeight) {
   _lib.set_background_image(viewer, path, fillHeight);
}

void set_background_image_position(Pointer<Void> viewer, double x, double y, bool clamp) {
   _lib.set_background_image_position(viewer, x, y, clamp);
}

void set_background_color(Pointer<Void> viewer, double r, double g, double b, double a) {
...
int add_light(Pointer<Void> viewer, int type, double colour, double intensity, double posX, double posY, double posZ, double dirX, double dirY, double dirZ, bool shadows) {
  return _lib.add_light(viewer, type, colour, intensity, posX, posY, posZ, dirX, dirY, dirZ, shadows);
}
...
int load_gltf(Pointer<Void> assetManager, Pointer<Char> assetPath, Pointer<Char> relativePath) {
...
void render(Pointer<Void> viewer, int frameTimeInNanos, Pointer<Void> pixelBuffer, Pointer<NativeFunction<Void Function(Pointer<Void>, Size, Pointer<Void>)>> callback, Pointer<Void> data) {
   _lib.render(viewer, frameTimeInNanos, pixelBuffer, callback, data);
}

void create_swap_chain(Pointer<Void> viewer, Pointer<Void> window, int width, int height) {
...
void update_viewport_and_camera_projection(Pointer<Void> viewer, int width, int height, double scaleFactor) {
   _lib.update_viewport_and_camera_projection(viewer, width, height, scaleFactor);
}
...
void apply_weights(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> weights, int count) {
   _lib.apply_weights(assetManager, asset, entityName, weights, count);
}

void set_morph_target_weights(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> morphData, int numWeights) {
   _lib.set_morph_target_weights(assetManager, asset, entityName, morphData, numWeights);
}

bool set_morph_animation(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> morphData, Pointer<Int> morphIndices, int numMorphTargets, int numFrames, double frameLengthInMs) {
  return _lib.set_morph_animation(assetManager, asset, entityName, morphData, morphIndices, numMorphTargets, numFrames, frameLengthInMs);
}

void reset_to_rest_pose(Pointer<Void> assetManager, int asset) {
   _lib.reset_to_rest_pose(assetManager, asset);
}

void add_bone_animation(Pointer<Void> assetManager, int asset, Pointer<Float> frameData, int numFrames, Pointer<Char> boneName, Pointer<Pointer<Char>> meshNames, int numMeshTargets, double frameLengthInMs, bool isModelSpace) {
   _lib.add_bone_animation(assetManager, asset, frameData, numFrames, boneName, meshNames, numMeshTargets, frameLengthInMs, isModelSpace);
}

bool set_bone_transform(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> transform, Pointer<Char> boneName) {
  return _lib.set_bone_transform(assetManager, asset, entityName, transform, boneName);
}

void play_animation(Pointer<Void> assetManager, int asset, int index, bool loop, bool reverse, bool replaceActive, double crossfade) {
   _lib.play_animation(assetManager, asset, index, loop, reverse, replaceActive, crossfade);
}

void set_animation_frame(Pointer<Void> assetManager, int asset, int animationIndex, int animationFrame) {
...
void get_animation_name(Pointer<Void> assetManager, int asset, Pointer<Char> outPtr, int index) {
   _lib.get_animation_name(assetManager, asset, outPtr, index);
}

double get_animation_duration(Pointer<Void> assetManager, int asset, int index) {
  return _lib.get_animation_duration(assetManager, asset, index);
}

void get_morph_target_name(Pointer<Void> assetManager, int asset, Pointer<Char> meshName, Pointer<Char> outPtr, int index) {
   _lib.get_morph_target_name(assetManager, asset, meshName, outPtr, index);
}

int get_morph_target_name_count(Pointer<Void> assetManager, int asset, Pointer<Char> meshName) {
...
bool set_material_color(Pointer<Void> assetManager, int asset, Pointer<Char> meshName, int materialIndex, double r, double g, double b, double a) {
  return _lib.set_material_color(assetManager, asset, meshName, materialIndex, r, g, b, a);
}
...
void set_position(Pointer<Void> assetManager, int asset, double x, double y, double z) {
   _lib.set_position(assetManager, asset, x, y, z);
}

void set_rotation(Pointer<Void> assetManager, int asset, double rads, double x, double y, double z) {
...
void set_camera_exposure(Pointer<Void> viewer, double aperture, double shutterSpeed, double sensitivity) {
...
void set_camera_rotation(Pointer<Void> viewer, double rads, double x, double y, double z) {
...
void set_camera_projection_matrix(Pointer<Void> viewer, Pointer<Double> matrix, double near, double far) {
...
void set_camera_manipulator_options(Pointer<Void> viewer, int mode, double orbitSpeedX, double orbitSpeedY, double zoomSpeed) {
   _lib.set_camera_manipulator_options(viewer, mode, orbitSpeedX, orbitSpeedY, zoomSpeed);
}
...
int find_child_entity_by_name(Pointer<Void> assetManager, int parent, Pointer<Char> name) {
  return _lib.find_child_entity_by_name(assetManager, parent, name);
}

int get_entity_count(Pointer<Void> assetManager, int target, bool renderableOnly) {
  return _lib.get_entity_count(assetManager, target, renderableOnly);
}

Pointer<Char> get_entity_name_at(Pointer<Void> assetManager, int target, int index, bool renderableOnly) {
  return _lib.get_entity_name_at(assetManager, target, index, renderableOnly);
}
...
void set_recording_output_directory(Pointer<Void> viewer, Pointer<Char> outputDirectory) {
...
Pointer<Void> create_filament_viewer_ffi(Pointer<Void> context, Pointer<Void> platform, Pointer<Char> uberArchivePath, Pointer<Void> loader, Pointer<NativeFunction<Void Function(Pointer<Void>)>> renderCallback, Pointer<Void> renderCallbackOwner) {
  return _lib.create_filament_viewer_ffi(context, platform, uberArchivePath, loader, renderCallback, renderCallbackOwner);
}

void create_filament_viewer_async_ffi(Pointer<Void> context, Pointer<Void> platform, Pointer<Char> uberArchivePath, Pointer<Void> loader, Pointer<NativeFunction<Void Function(Pointer<Void>)>> renderCallback, Pointer<Void> renderCallbackOwner, Pointer<Pointer<Void>> out) {
   _lib.create_filament_viewer_async_ffi(context, platform, uberArchivePath, loader, renderCallback, renderCallbackOwner, out);
}

void create_swap_chain_ffi(Pointer<Void> viewer, Pointer<Void> surface, int width, int height) {
...
void create_render_target_ffi(Pointer<Void> viewer, int nativeTextureId, int width, int height) {
...
Pointer<NativeFunction<Void Function(Pointer<Void>)>> make_render_callback_fn_pointer(Pointer<NativeFunction<Void Function(Pointer<Void>)>> arg0) {
...
void update_viewport_and_camera_projection_ffi(Pointer<Void> viewer, int width, int height, double scaleFactor) {
   _lib.update_viewport_and_camera_projection_ffi(viewer, width, height, scaleFactor);
}

void set_background_color_ffi(Pointer<Void> viewer, double r, double g, double b, double a) {
...
void set_background_image_ffi(Pointer<Void> viewer, Pointer<Char> path, bool fillHeight) {
   _lib.set_background_image_ffi(viewer, path, fillHeight);
}

void set_background_image_position_ffi(Pointer<Void> viewer, double x, double y, bool clamp) {
...
int add_light_ffi(Pointer<Void> viewer, int type, double colour, double intensity, double posX, double posY, double posZ, double dirX, double dirY, double dirZ, bool shadows) {
...
void load_glb_async_ffi(Pointer<Void> assetManager, Pointer<Char> assetPath, Pointer<Int32> out) {
   _lib.load_glb_async_ffi(assetManager, assetPath, out);
}

int load_gltf_ffi(Pointer<Void> assetManager, Pointer<Char> assetPath, Pointer<Char> relativePath) {
...
void apply_weights_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> weights, int count) {
   _lib.apply_weights_ffi(assetManager, asset, entityName, weights, count);
}

void play_animation_ffi(Pointer<Void> assetManager, int asset, int index, bool loop, bool reverse, bool replaceActive, double crossfade) {
   _lib.play_animation_ffi(assetManager, asset, index, loop, reverse, replaceActive, crossfade);
}

void set_animation_frame_ffi(Pointer<Void> assetManager, int asset, int animationIndex, int animationFrame) {
   _lib.set_animation_frame_ffi(assetManager, asset, animationIndex, animationFrame);
}
...
void get_animation_name_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> outPtr, int index) {
   _lib.get_animation_name_ffi(assetManager, asset, outPtr, index);
}

void get_morph_target_name_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> meshName, Pointer<Char> outPtr, int index) {
   _lib.get_morph_target_name_ffi(assetManager, asset, meshName, outPtr, index);
}

int get_morph_target_name_count_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> meshName) {
  return _lib.get_morph_target_name_count_ffi(assetManager, asset, meshName);
}

void set_morph_target_weights_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> morphData, int numWeights) {
   _lib.set_morph_target_weights_ffi(assetManager, asset, entityName, morphData, numWeights);
}

bool set_morph_animation_ffi(Pointer<Void> assetManager, int asset, Pointer<Char> entityName, Pointer<Float> morphData, Pointer<Int> morphIndices, int numMorphTargets, int numFrames, double frameLengthInMs) {
  return _lib.set_morph_animation_ffi(assetManager, asset, entityName, morphData, morphIndices, numMorphTargets, numFrames, frameLengthInMs);
}
...
void reset_to_rest_pose_ffi(Pointer<Void> assetManager, int entityId) {
   _lib.reset_to_rest_pose_ffi(assetManager, entityId);
}
