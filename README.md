...
To use the wasm binaries in your own project, you will need to copy the files under `example/assets/web/` to the assets folder for your own app (and make sure these are reflected in your `pubspec.yaml`). You will also need to modify the `main.dart.js` generated by your project as follows:
...
If you use the same asset folder structure as the example project, in most cases you can simply overwrite the generated `build/web_wasm/main.dart.js` file in your app with `web/src/js/main.dart.js`.
